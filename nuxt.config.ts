...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { charset: 'utf-8' },
        // 다크 전환 시 colorMode.client 플러그인의 useHead 가 같은 name 으로 이 항목을 덮어쓴다.
        // key 를 주면 dedupe 키가 name 기준과 갈라져 태그가 2개가 된다(unhead 2.1.13 실측).
  ...
  icon: {
    ...
    clientBundle: {
      ...
      icons: [
        ...
        'lucide:edit-2',
        // 아프젝 BottomNav 5종 (layouts/default.vue 동적 :name 바인딩 — scan 미검출이라 명시 필수)
        'lucide:ellipsis',
        'lucide:footprints',
        'lucide:gem',
        'lucide:gift',
