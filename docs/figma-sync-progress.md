...
|----|-------------------------------|----------------------------------|----------|------|
| 1  | `app/pages/Root.tsx`          | `app/layouts/default.vue`        | todo     | 바텀 탭 네비게이션 레이아웃 |
| 2  | `app/pages/MyTerra.tsx`       | `app/pages/index.vue`            | todo     | 메인 테라리움 뷰 |
| 3  | `app/pages/Record.tsx`        | `app/pages/record/index.vue`     | todo     | 기록/활동 로그 |
| 4  | `app/pages/Calendar.tsx`      | `app/pages/calendar/index.vue`   | todo     | **신규 페이지 생성 필요** |
...
| 페이지           | 사용할 API                                                   | 상태  |
|------------------|--------------------------------------------------------------|-------|
| index (MyTerra)  | `getApiV1Terrarium`, `getApiV1UsersMe`                       | todo  |
| record           | `getApiV1Records`, `postApiV1Records`, `getApiV1RecordsStatistics` | todo |
| calendar         | `getApiV1NotesDate`                                          | todo  |
