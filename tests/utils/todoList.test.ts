...
// 투두 시트 정렬 규칙 (Figma 댓글 #59/#60/#62) — 수기 항목 맨 위, 루틴 항목 그 아래 고정, 묶음 안은 최근 추가 상단.
describe('todoList 정렬', () => {
  ...
  it('수기 항목이 루틴 항목보다 위, 각 묶음은 최근 추가가 먼저', () => {
  ...
  it('수기 추가는 정렬된 배열을 돌려주고 빈 텍스트·상한 초과는 null', () => {
  ...
  it('루틴 프리필은 중복 routineId 를 건너뛰고 상한까지만 채운다', () => {
